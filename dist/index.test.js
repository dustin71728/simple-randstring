...
describe('Test randomString', function () {
    it('should return string that the length is specified by the argument', function () {
        index_1.randomString(10, false).length.should.be.equal(10);
        index_1.randomString(10, true).length.should.be.equal(10);
        index_1.randomString(50, false).length.should.be.equal(50);
        index_1.randomString(50, true).length.should.be.equal(50);
        index_1.randomString(1000, false).length.should.be.equal(1000);
        index_1.randomString(1000, true).length.should.be.equal(1000);
        index_1.randomString(10000, false).length.should.be.equal(10000);
        index_1.randomString(10000, true).length.should.be.equal(10000);
    });
});
...
describe('Examine random string', function () {
    it('should return deviation ratio less than 0.02 when strongCrypto is on', function () {
        ...
        for (var i = 0; i < 10000; ++i) {
            Statistics1.setElements(index_1.randomString(30, true));
        }
    ...
    it('should return deviation ratio less than 0.16 when strongCrypto is off', function () {
        var Statistics1 = new Statistics();
        for (var i = 0; i < 10000; ++i) {
            Statistics1.setElements(index_1.randomString(30, false));
        }
